...
def main():
    ...
    best_model_path = f"{config['save_dir']}/trained_models/debug_model_2{noise_level_str}.pth"
    ...
    if training_mode:
        ...
        results_fig_path = f"{config['save_dir']}/figs/debug_fig_2{noise_level_str}.png"
