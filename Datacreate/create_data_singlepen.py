...
class SinglePendulum:
    ...
    def split_data(self, train_size=1000, valid_size=200, test_size=1000, timestep=5):
        ...
        # noisy 데이터를 학습 및 검증용으로 사용하고, clean 데이터를 테스트용으로 사용합니다.
        ...
        # 겹치는 데이터 확인
        train_val_overlap = np.intersect1d(train_indices, valid_indices)
        train_test_overlap = np.intersect1d(train_indices, test_indices)
        val_test_overlap = np.intersect1d(valid_indices, test_indices)
