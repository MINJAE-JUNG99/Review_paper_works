...
def plot_results(time: torch.Tensor, true_data: torch.Tensor, pred_data: torch.Tensor, title: str, save_path: Optional[str] = None):
    """
    double pendulum의 경우, 여기서는 각가속도(인덱스 2와 5)를 플롯합니다.
    true_data, pred_data: shape (T,6)
    """
...
def main():
    ...
    if training_mode:
        ...
        results_fig_path = f"{config['save_dir']}/figs/double_pen_NODE_moderate_fig_{noise_level_str}.png"
